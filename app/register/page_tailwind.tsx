  ...
  return (
    <div>
      ...
      <div className="flex h-screen w-screen overflow-hidden fixed top-0 left-0">
        {currentPage === "details" ? (
          <div className="relative flex justify-center items-center bg-white h-full text-black w-2/5 max-w-[750px] min-w-[400px] max-[500px]:w-full">
            <div className="absolute top-0 left-0 w-full h-[30%] min-[500px]:hidden">
              <Banner decorative />
            </div>
            <div
              className="mt-12 md:mt-0 bg-white p-[50px] flex flex-col w-3/4"
          ...
          <div className="relative flex justify-center items-center bg-white h-full text-black w-2/5 max-w-[750px] min-w-[400px] max-[500px]:w-full">
            ...
            <div className="bg-white p-[50px] flex flex-col w-3/4"
              style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif' }}>
              <Logo pic="/acm_wordmark_chapter.svg" />
              <h1 className="text-[2rem] font-semibold mb-8">Registration Complete</h1>
