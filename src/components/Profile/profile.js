            ...
            return (
                <div>
                    ...
                    <div className="profile-wrapper">
                        ...
                        <div className="form-elem">
                            <Button className="profile-action-button" style={ this.profileUpdated() ? "green" : "disabled" } text="Save" />
                        ...
                        <div className="divider"></div>
                        <div className="form-elem">
                            <Button className="profile-action-button" style="blue" text="Change Password" onClick={this.showChangePassword} />
                        </div>
                    </div>
                </div>
            );
