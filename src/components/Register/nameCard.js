        ...
        <div className="inner">
          <form onSubmit={this.props.onSubmit} autoComplete="off">
            <div>
              ...
              <input type="text" className="input-large" name="firstName" onChange={this.handleChange} />
            </div>
            <div>
              <p className="text">Last Name</p>
              <input type="text" className="input-large" name="lastName" onChange={this.handleChange} />
            </div>
