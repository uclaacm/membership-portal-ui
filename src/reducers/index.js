...
import {Auth, LoginUser, LogoutUser, RequestResetPassword, ResetPassword} from './auth';
...
const Action = {
  LoginUser, LogoutUser, FetchUser, UpdateUser, UserUpdateDone, RequestResetPassword, ResetPassword,
